...
type
  ...
  VkDescriptorUpdateTemplateKHR* = distinct pointer
  VkSamplerYcbcrConversion* = distinct pointer
  VkSamplerYcbcrConversionKHR* = distinct pointer
  VkValidationCacheEXT* = distinct pointer
  VkAccelerationStructureKHR* = distinct pointer
  VkAccelerationStructureNV* = distinct pointer
  ...
  VkAttachmentLoadOp* {.size: 4.} = enum # XXX
    VK_ATTACHMENT_LOAD_OP_LOAD = 0
    VK_ATTACHMENT_LOAD_OP_CLEAR = 1
    VK_ATTACHMENT_LOAD_OP_DONT_CARE = 2
  VkAttachmentStoreOp* {.size: 4.} = enum # XXX
    VK_ATTACHMENT_STORE_OP_STORE = 0
    VK_ATTACHMENT_STORE_OP_DONT_CARE = 1
    VK_ATTACHMENT_STORE_OP_NONE_QCOM = 1000301000
  VkBlendFactor* {.size: 4.} = enum # XXX
  ...
  VkFramebufferCreateFlag* {.size: 4.} = enum
    VK_FRAMEBUFFER_CREATE_IMAGELESS = 0
  VkRenderPassCreateFlagBits* {.size: 4.} = enum
    VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM = 2
  VkRenderPassCreateFlag* {.size: 4.} = enum
    VK_RENDER_PASS_CREATE_TRANSFORM_QCOM = 1
  ...
  VkSamplerCreateFlag* {.size: 4.} = enum
    VK_SAMPLER_CREATE_SUBSAMPLED_EXT = 0
    VK_SAMPLER_CREATE_SUBSAMPLED_COARSE_RECONSTRUCTION_EXT = 1
  VkPipelineCacheHeaderVersion* {.size: 4.} = enum # XXX
    VK_PIPELINE_CACHE_HEADER_VERSION_ONE = 1
  VkPipelineCacheCreateFlagBits* {.size: 4.} = enum
    VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT_EXT = 1
  VkPipelineCacheCreateFlag* {.size: 4.} = enum
    VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_EXT = 0
  ...
  VkPipelineShaderStageCreateFlag* {.size: 4.} = enum
    VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_EXT = 0
    VK_PIPELINE_SHADER_STAGE_CREATE_REQUIRE_FULL_SUBGROUPS_EXT = 1
  ...
  VkDescriptorSetLayoutCreateFlag* {.size: 4.} = enum
    VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_KHR = 0
    VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL = 1
  VkDeviceQueueCreateFlagBits* {.size: 4.} = enum
    VK_DEVICE_QUEUE_CREATE_PROTECTED_BIT = 1
  VkDeviceQueueCreateFlag* {.size: 4.} = enum
    VK_DEVICE_QUEUE_CREATE_PROTECTED = 0
  ...
  VkBufferCreateFlag* {.size: 4.} = enum
    VK_BUFFER_CREATE_SPARSE_BINDING = 0
    VK_BUFFER_CREATE_SPARSE_RESIDENCY = 1
    VK_BUFFER_CREATE_SPARSE_ALIASED = 2
    VK_BUFFER_CREATE_PROTECTED = 3
    VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY = 4
  ...
  VkBufferUsageFlag* {.size: 4.} = enum
    VK_BUFFER_USAGE_TRANSFER_SRC = 0
    VK_BUFFER_USAGE_TRANSFER_DST = 1
    VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER = 2
    VK_BUFFER_USAGE_STORAGE_TEXEL_BUFFER = 3
    VK_BUFFER_USAGE_UNIFORM_BUFFER = 4
    VK_BUFFER_USAGE_STORAGE_BUFFER = 5
    VK_BUFFER_USAGE_INDEX_BUFFER = 6
    VK_BUFFER_USAGE_VERTEX_BUFFER = 7
    VK_BUFFER_USAGE_INDIRECT_BUFFER = 8
    VK_BUFFER_USAGE_CONDITIONAL_RENDERING_EXT = 9
    VK_BUFFER_USAGE_RAY_TRACING_KHR = 10
    VK_BUFFER_USAGE_TRANSFORM_FEEDBACK_BUFFER_EXT = 11
    VK_BUFFER_USAGE_TRANSFORM_FEEDBACK_COUNTER_BUFFER_EXT = 12
    VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS = 17
  VkColorComponentFlagBits* {.size: 4.} = enum
    VK_COLOR_COMPONENT_R_BIT = 1
    VK_COLOR_COMPONENT_G_BIT = 2
    VK_COLOR_COMPONENT_B_BIT = 4
    VK_COLOR_COMPONENT_A_BIT = 8
  VkColorComponentFlag* {.size: 4.} = enum
    VK_COLOR_COMPONENT_R = 0
    VK_COLOR_COMPONENT_G = 1
    VK_COLOR_COMPONENT_B = 2
    VK_COLOR_COMPONENT_A = 3
  VkComponentSwizzle* {.size: 4.} = enum # XXX
  ...
  VkCommandPoolCreateFlag* {.size: 4.} = enum
    VK_COMMAND_POOL_CREATE_TRANSIENT = 0
    VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER = 1
    VK_COMMAND_POOL_CREATE_PROTECTED = 2
  VkCommandPoolResetFlagBits* {.size: 4.} = enum
    VK_COMMAND_POOL_RESET_RELEASE_RESOURCES_BIT = 1
  VkCommandPoolResetFlag* {.size: 4.} = enum
    VK_COMMAND_POOL_RESET_RELEASE_RESOURCES = 0
  VkCommandBufferResetFlagBits* {.size: 4.} = enum
    VK_COMMAND_BUFFER_RESET_RELEASE_RESOURCES_BIT = 1
  VkCommandBufferResetFlag* {.size: 4.} = enum
    VK_COMMAND_BUFFER_RESET_RELEASE_RESOURCES = 0
  VkCommandBufferLevel* {.size: 4.} = enum # XXX
  ...
  VkCommandBufferUsageFlag* {.size: 4.} = enum
    VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT = 0
    VK_COMMAND_BUFFER_USAGE_RENDER_PASS_CONTINUE = 1
    VK_COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE = 2
  VkCompareOp* {.size: 4.} = enum # XXX
  ...
  VkCullModeFlag* {.size: 4.} = enum
    VK_CULL_MODE_FRONT = 0
    VK_CULL_MODE_BACK = 1
  VkDescriptorType* {.size: 4.} = enum # XXX
  ...
  VkDynamicState* {.size: 4.} = enum # XXX
  ...
  VkFenceCreateFlag* {.size: 4.} = enum
    VK_FENCE_CREATE_SIGNALED = 0
  VkPolygonMode* {.size: 4.} = enum # XXX
    VK_POLYGON_MODE_FILL = 0
    VK_POLYGON_MODE_LINE = 1
    VK_POLYGON_MODE_POINT = 2
    VK_POLYGON_MODE_FILL_RECTANGLE_NV = 1000153000
  VkFormat* {.size: 4.} = enum # XXX
  ...
  VkFormatFeatureFlag* {.size: 4.} = enum
    VK_FORMAT_FEATURE_SAMPLED_IMAGE = 0
    VK_FORMAT_FEATURE_STORAGE_IMAGE = 1
    VK_FORMAT_FEATURE_STORAGE_IMAGE_ATOMIC = 2
    VK_FORMAT_FEATURE_UNIFORM_TEXEL_BUFFER = 3
    VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER = 4
    VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_ATOMIC = 5
    VK_FORMAT_FEATURE_VERTEX_BUFFER = 6
    VK_FORMAT_FEATURE_COLOR_ATTACHMENT = 7
    VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND = 8
    VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT = 9
    VK_FORMAT_FEATURE_BLIT_SRC = 10
    VK_FORMAT_FEATURE_BLIT_DST = 11
    VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR = 12
    VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_IMG = 13
    VK_FORMAT_FEATURE_TRANSFER_SRC = 14
    VK_FORMAT_FEATURE_TRANSFER_DST = 15
    VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX = 16
    VK_FORMAT_FEATURE_MIDPOINT_CHROMA_SAMPLES = 17
    VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER = 18
    VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER = 19
    VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT = 20
    VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE = 21
    VK_FORMAT_FEATURE_DISJOINT = 22
    VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES = 23
    VK_FORMAT_FEATURE_FRAGMENT_DENSITY_MAP_EXT = 24
    VK_FORMAT_FEATURE_ACCELERATION_STRUCTURE_VERTEX_BUFFER_KHR = 29
  VkFrontFace* {.size: 4.} = enum # XXX
  ...
  VkImageAspectFlag* {.size: 4.} = enum
    VK_IMAGE_ASPECT_COLOR = 0
    VK_IMAGE_ASPECT_DEPTH = 1
    VK_IMAGE_ASPECT_STENCIL = 2
    VK_IMAGE_ASPECT_METADATA = 3
    VK_IMAGE_ASPECT_PLANE_0 = 4
    VK_IMAGE_ASPECT_PLANE_1 = 5
    VK_IMAGE_ASPECT_PLANE_2 = 6
    VK_IMAGE_ASPECT_MEMORY_PLANE_0_EXT = 7
    VK_IMAGE_ASPECT_MEMORY_PLANE_1_EXT = 8
    VK_IMAGE_ASPECT_MEMORY_PLANE_2_EXT = 9
    VK_IMAGE_ASPECT_MEMORY_PLANE_3_EXT = 10
  ...
  VkImageCreateFlag* {.size: 4.} = enum
    VK_IMAGE_CREATE_SPARSE_BINDING = 0
    VK_IMAGE_CREATE_SPARSE_RESIDENCY = 1
    VK_IMAGE_CREATE_SPARSE_ALIASED = 2
    VK_IMAGE_CREATE_MUTABLE_FORMAT = 3
    VK_IMAGE_CREATE_CUBE_COMPATIBLE = 4
    VK_IMAGE_CREATE_2D_ARRAY_COMPATIBLE = 5
    VK_IMAGE_CREATE_SPLIT_INSTANCE_BIND_REGIONS = 6
    VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE = 7
    VK_IMAGE_CREATE_EXTENDED_USAGE = 8
    VK_IMAGE_CREATE_DISJOINT = 9
    VK_IMAGE_CREATE_ALIAS = 10
    VK_IMAGE_CREATE_PROTECTED = 11
    VK_IMAGE_CREATE_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_EXT = 12
    VK_IMAGE_CREATE_CORNER_SAMPLED_NV = 13
    VK_IMAGE_CREATE_SUBSAMPLED_EXT = 14
  VkImageLayout* {.size: 4.} = enum # XXX
  ...
  VkImageTiling* {.size: 4.} = enum # XXX
    VK_IMAGE_TILING_OPTIMAL = 0
    VK_IMAGE_TILING_LINEAR = 1
    VK_IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT = 1000158000
  VkImageType* {.size: 4.} = enum # XXX
    VK_IMAGE_TYPE_1D = 0
    VK_IMAGE_TYPE_2D = 1
    VK_IMAGE_TYPE_3D = 2
  ...
  VkImageUsageFlag* {.size: 4.} = enum
    VK_IMAGE_USAGE_TRANSFER_SRC = 0
    VK_IMAGE_USAGE_TRANSFER_DST = 1
    VK_IMAGE_USAGE_SAMPLED = 2
    VK_IMAGE_USAGE_STORAGE = 3
    VK_IMAGE_USAGE_COLOR_ATTACHMENT = 4
    VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT = 5
    VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT = 6
    VK_IMAGE_USAGE_INPUT_ATTACHMENT = 7
    VK_IMAGE_USAGE_SHADING_RATE_IMAGE_NV = 8
    VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_EXT = 9
  ...
  VkImageViewCreateFlag* {.size: 4.} = enum
    VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DYNAMIC_EXT = 0
    VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DEFERRED_EXT = 1
  VkImageViewType* {.size: 4.} = enum # XXX
  ...
  VkSharingMode* {.size: 4.} = enum # XXX
    VK_SHARING_MODE_EXCLUSIVE = 0
    VK_SHARING_MODE_CONCURRENT = 1
  VkIndexType* {.size: 4.} = enum # XXX
    VK_INDEX_TYPE_UINT16 = 0
    VK_INDEX_TYPE_UINT32 = 1
    VK_INDEX_TYPE_NONE_KHR = 1000165000
    VK_INDEX_TYPE_UINT8_EXT = 1000265000
  VkLogicOp* {.size: 4.} = enum # XXX
    VK_LOGIC_OP_CLEAR = 0
    VK_LOGIC_OP_AND = 1
  ...
  VkMemoryHeapFlag* {.size: 4.} = enum
    VK_MEMORY_HEAP_DEVICE_LOCAL = 0
    VK_MEMORY_HEAP_MULTI_INSTANCE = 1
  ...
  VkAccessFlag* {.size: 4.} = enum
    VK_ACCESS_INDIRECT_COMMAND_READ = 0
    VK_ACCESS_INDEX_READ = 1
    VK_ACCESS_VERTEX_ATTRIBUTE_READ = 2
    VK_ACCESS_UNIFORM_READ = 3
    VK_ACCESS_INPUT_ATTACHMENT_READ = 4
    VK_ACCESS_SHADER_READ = 5
    VK_ACCESS_SHADER_WRITE = 6
    VK_ACCESS_COLOR_ATTACHMENT_READ = 7
    VK_ACCESS_COLOR_ATTACHMENT_WRITE = 8
    VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ = 9
    VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE = 10
    VK_ACCESS_TRANSFER_READ = 11
    VK_ACCESS_TRANSFER_WRITE = 12
    VK_ACCESS_HOST_READ = 13
    VK_ACCESS_HOST_WRITE = 14
    VK_ACCESS_MEMORY_READ = 15
    VK_ACCESS_MEMORY_WRITE = 16
    VK_ACCESS_COMMAND_PREPROCESS_READ_NV = 17
    VK_ACCESS_COMMAND_PREPROCESS_WRITE_NV = 18
    VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = 19
    VK_ACCESS_CONDITIONAL_RENDERING_READ_EXT = 20
    VK_ACCESS_ACCELERATION_STRUCTURE_READ_KHR = 21
    VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_KHR = 22
    VK_ACCESS_SHADING_RATE_IMAGE_READ_NV = 23
    VK_ACCESS_FRAGMENT_DENSITY_MAP_READ_EXT = 24
    VK_ACCESS_TRANSFORM_FEEDBACK_WRITE_EXT = 25
    VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_READ_EXT = 26
    VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT = 27
  ...
  VkMemoryPropertyFlag* {.size: 4.} = enum
    VK_MEMORY_PROPERTY_DEVICE_LOCAL = 0
    VK_MEMORY_PROPERTY_HOST_VISIBLE = 1
    VK_MEMORY_PROPERTY_HOST_COHERENT = 2
    VK_MEMORY_PROPERTY_HOST_CACHED = 3
    VK_MEMORY_PROPERTY_LAZILY_ALLOCATED = 4
    VK_MEMORY_PROPERTY_PROTECTED = 5
    VK_MEMORY_PROPERTY_DEVICE_COHERENT_AMD = 6
    VK_MEMORY_PROPERTY_DEVICE_UNCACHED_AMD = 7
  VkPhysicalDeviceType* {.size: 4.} = enum # XXX
    VK_PHYSICAL_DEVICE_TYPE_OTHER = 0
    VK_PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU = 1
    VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU = 2
    VK_PHYSICAL_DEVICE_TYPE_VIRTUAL_GPU = 3
    VK_PHYSICAL_DEVICE_TYPE_CPU = 4
  VkPipelineBindPoint* {.size: 4.} = enum # XXX
  ...
  VkPipelineCreateFlag* {.size: 4.} = enum
    VK_PIPELINE_CREATE_DISABLE_OPTIMIZATION = 0
    VK_PIPELINE_CREATE_ALLOW_DERIVATIVES = 1
    VK_PIPELINE_CREATE_DERIVATIVE = 2
    VK_PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX = 3
    VK_PIPELINE_CREATE_DISPATCH_BASE = 4
    VK_PIPELINE_CREATE_DEFER_COMPILE_NV = 5
    VK_PIPELINE_CREATE_CAPTURE_STATISTICS_KHR = 6
    VK_PIPELINE_CREATE_CAPTURE_INTERNAL_REPRESENTATIONS_KHR = 7
    VK_PIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_EXT = 8
    VK_PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_EXT = 9
    VK_PIPELINE_CREATE_LIBRARY_KHR = 11
    VK_PIPELINE_CREATE_RAY_TRACING_SKIP_TRIANGLES_KHR = 12
    VK_PIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_KHR = 13
    VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_KHR = 14
    VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_KHR = 15
    VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_KHR = 16
    VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_KHR = 17
    VK_PIPELINE_CREATE_INDIRECT_BINDABLE_NV = 18
  VkPrimitiveTopology* {.size: 4.} = enum # XXX
  ...
  VkQueryControlFlag* {.size: 4.} = enum
    VK_QUERY_CONTROL_PRECISE = 0
  ...
  VkQueryPipelineStatisticFlag* {.size: 4.} = enum
    VK_QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_VERTICES = 0
    VK_QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_PRIMITIVES = 1
    VK_QUERY_PIPELINE_STATISTIC_VERTEX_SHADER_INVOCATIONS = 2
    VK_QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_INVOCATIONS = 3
    VK_QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_PRIMITIVES = 4
    VK_QUERY_PIPELINE_STATISTIC_CLIPPING_INVOCATIONS = 5
    VK_QUERY_PIPELINE_STATISTIC_CLIPPING_PRIMITIVES = 6
    VK_QUERY_PIPELINE_STATISTIC_FRAGMENT_SHADER_INVOCATIONS = 7
    VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_CONTROL_SHADER_PATCHES = 8
    VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_EVALUATION_SHADER_INVOCATIONS = 9
    VK_QUERY_PIPELINE_STATISTIC_COMPUTE_SHADER_INVOCATIONS = 10
  VkQueryResultFlagBits* {.size: 4.} = enum
    VK_QUERY_RESULT_64_BIT = 1
    VK_QUERY_RESULT_WAIT_BIT = 2
    VK_QUERY_RESULT_WITH_AVAILABILITY_BIT = 4
    VK_QUERY_RESULT_PARTIAL_BIT = 8
  VkQueryResultFlag* {.size: 4.} = enum
    VK_QUERY_RESULT_64 = 0
    VK_QUERY_RESULT_WAIT = 1
    VK_QUERY_RESULT_WITH_AVAILABILITY = 2
    VK_QUERY_RESULT_PARTIAL = 3
  VkQueryType* {.size: 4.} = enum # XXX
  ...
  VkQueueFlag* {.size: 4.} = enum
    VK_QUEUE_GRAPHICS = 0
    VK_QUEUE_COMPUTE = 1
    VK_QUEUE_TRANSFER = 2
    VK_QUEUE_SPARSE_BINDING = 3
    VK_QUEUE_PROTECTED = 4
  VkSubpassContents* {.size: 4.} = enum # XXX
    VK_SUBPASS_CONTENTS_INLINE = 0
    VK_SUBPASS_CONTENTS_SECONDARY_COMMAND_BUFFERS = 1
  VkResult* {.size: 4.} = enum # XXX
  ...
  VkShaderStageFlag* {.size: 4.} = enum
    ...
    VK_SHADER_STAGE_TASK_NV = 6
    VK_SHADER_STAGE_MESH_NV = 7
    VK_SHADER_STAGE_RAYGEN_KHR = 8
    VK_SHADER_STAGE_ANY_HIT_KHR = 9
    VK_SHADER_STAGE_CLOSEST_HIT_KHR = 10
    VK_SHADER_STAGE_MISS_KHR = 11
    VK_SHADER_STAGE_INTERSECTION_KHR = 12
    VK_SHADER_STAGE_CALLABLE_KHR = 13
  VkSparseMemoryBindFlagBits* {.size: 4.} = enum
    VK_SPARSE_MEMORY_BIND_METADATA_BIT = 1
  VkSparseMemoryBindFlag* {.size: 4.} = enum
    VK_SPARSE_MEMORY_BIND_METADATA = 0
  VkStencilFaceFlagBits* {.size: 4.} = enum
    VK_STENCIL_FACE_FRONT_BIT = 1
    VK_STENCIL_FACE_BACK_BIT = 2
  VkStencilFaceFlag* {.size: 4.} = enum
    VK_STENCIL_FACE_FRONT = 0
    VK_STENCIL_FACE_BACK = 1
  VkStencilOp* {.size: 4.} = enum # XXX
  ...
  VkStructureType* {.size: 4.} = enum # XXX
  ...
  VkSystemAllocationScope* {.size: 4.} = enum # XXX
    VK_SYSTEM_ALLOCATION_SCOPE_COMMAND = 0
    VK_SYSTEM_ALLOCATION_SCOPE_OBJECT = 1
    VK_SYSTEM_ALLOCATION_SCOPE_CACHE = 2
    VK_SYSTEM_ALLOCATION_SCOPE_DEVICE = 3
    VK_SYSTEM_ALLOCATION_SCOPE_INSTANCE = 4
  VkInternalAllocationType* {.size: 4.} = enum # XXX
    VK_INTERNAL_ALLOCATION_TYPE_EXECUTABLE = 0
  VkSamplerAddressMode* {.size: 4.} = enum # XXX
    VK_SAMPLER_ADDRESS_MODE_REPEAT = 0
    VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT = 1
    VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE = 2
    VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER = 3
    VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE = 4
  VkFilter* {.size: 4.} = enum # XXX
    VK_FILTER_NEAREST = 0
    VK_FILTER_LINEAR = 1
    VK_FILTER_CUBIC_IMG = 1000015000
  VkSamplerMipmapMode* {.size: 4.} = enum # XXX
    VK_SAMPLER_MIPMAP_MODE_NEAREST = 0
    VK_SAMPLER_MIPMAP_MODE_LINEAR = 1
  VkVertexInputRate* {.size: 4.} = enum # XXX
  ...
  VkPipelineStageFlag* {.size: 4.} = enum
    VK_PIPELINE_STAGE_TOP_OF_PIPE = 0
    VK_PIPELINE_STAGE_DRAW_INDIRECT = 1
    VK_PIPELINE_STAGE_VERTEX_INPUT = 2
    VK_PIPELINE_STAGE_VERTEX_SHADER = 3
    VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER = 4
    VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER = 5
    VK_PIPELINE_STAGE_GEOMETRY_SHADER = 6
    VK_PIPELINE_STAGE_FRAGMENT_SHADER = 7
    VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS = 8
    VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS = 9
    VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT = 10
    VK_PIPELINE_STAGE_COMPUTE_SHADER = 11
    VK_PIPELINE_STAGE_TRANSFER = 12
    VK_PIPELINE_STAGE_BOTTOM_OF_PIPE = 13
    VK_PIPELINE_STAGE_HOST = 14
    VK_PIPELINE_STAGE_ALL_GRAPHICS = 15
    VK_PIPELINE_STAGE_ALL_COMMANDS = 16
    VK_PIPELINE_STAGE_COMMAND_PREPROCESS_NV = 17
    VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_EXT = 18
    VK_PIPELINE_STAGE_TASK_SHADER_NV = 19
    VK_PIPELINE_STAGE_MESH_SHADER_NV = 20
    VK_PIPELINE_STAGE_RAY_TRACING_SHADER_KHR = 21
    VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_NV = 22
    VK_PIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_EXT = 23
    VK_PIPELINE_STAGE_TRANSFORM_FEEDBACK_EXT = 24
    VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_KHR = 25
  VkSparseImageFormatFlagBits* {.size: 4.} = enum
    VK_SPARSE_IMAGE_FORMAT_SINGLE_MIPTAIL_BIT = 1
    VK_SPARSE_IMAGE_FORMAT_ALIGNED_MIP_SIZE_BIT = 2
    VK_SPARSE_IMAGE_FORMAT_NONSTANDARD_BLOCK_SIZE_BIT = 4
  VkSparseImageFormatFlag* {.size: 4.} = enum
    VK_SPARSE_IMAGE_FORMAT_SINGLE_MIPTAIL = 0
    VK_SPARSE_IMAGE_FORMAT_ALIGNED_MIP_SIZE = 1
    VK_SPARSE_IMAGE_FORMAT_NONSTANDARD_BLOCK_SIZE = 2
  ...
  VkSampleCountFlag* {.size: 4.} = enum
    VK_SAMPLE_COUNT_1 = 0
    VK_SAMPLE_COUNT_2 = 1
    VK_SAMPLE_COUNT_4 = 2
    VK_SAMPLE_COUNT_8 = 3
    VK_SAMPLE_COUNT_16 = 4
    VK_SAMPLE_COUNT_32 = 5
    VK_SAMPLE_COUNT_64 = 6
  VkAttachmentDescriptionFlagBits* {.size: 4.} = enum
    VK_ATTACHMENT_DESCRIPTION_MAY_ALIAS_BIT = 1
  VkAttachmentDescriptionFlag* {.size: 4.} = enum
    VK_ATTACHMENT_DESCRIPTION_MAY_ALIAS = 0
  VkDescriptorPoolCreateFlagBits* {.size: 4.} = enum
    VK_DESCRIPTOR_POOL_CREATE_FREE_DESCRIPTOR_SET_BIT = 1
    VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT = 2
  VkDescriptorPoolCreateFlag* {.size: 4.} = enum
    VK_DESCRIPTOR_POOL_CREATE_FREE_DESCRIPTOR_SET = 0
    VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND = 1
  VkDependencyFlagBits* {.size: 4.} = enum
    VK_DEPENDENCY_BY_REGION_BIT = 1
    VK_DEPENDENCY_VIEW_LOCAL_BIT = 2
    VK_DEPENDENCY_DEVICE_GROUP_BIT = 4
  VkDependencyFlag* {.size: 4.} = enum
    VK_DEPENDENCY_BY_REGION = 0
    VK_DEPENDENCY_VIEW_LOCAL = 1
    VK_DEPENDENCY_DEVICE_GROUP = 2
  VkObjectType* {.size: 4.} = enum # XXX
  ...
  VkIndirectCommandsLayoutUsageFlagNV* {.size: 4.} = enum
    VK_INDIRECT_COMMANDS_LAYOUT_USAGE_EXPLICIT_PREPROCESS_NV = 0
    VK_INDIRECT_COMMANDS_LAYOUT_USAGE_INDEXED_SEQUENCES_NV = 1
    VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_NV = 2
  VkIndirectCommandsTokenTypeNV* {.size: 4.} = enum # XXX
  ...
  VkIndirectStateFlagNV* {.size: 4.} = enum
    VK_INDIRECT_STATE_FLAG_FRONTFACE_NV = 0
  VkPrivateDataSlotCreateFlagBitsEXT* = enum
    VkPrivateDataSlotCreateFlagBitsEXTReserved
  VkDescriptorUpdateTemplateType* {.size: 4.} = enum # XXX
    VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_DESCRIPTOR_SET = 0
    VK_DESCRIPTOR_UPDATE_TEMPLATE_TYPE_PUSH_DESCRIPTORS_KHR = 1
  VkDescriptorUpdateTemplateTypeKHR* = enum
    VkDescriptorUpdateTemplateTypeKHRReserved
  VkViewportCoordinateSwizzleNV* {.size: 4.} = enum # XXX
  ...
  VkDiscardRectangleModeEXT* {.size: 4.} = enum # XXX
  ...
  VkSubpassDescriptionFlag* {.size: 4.} = enum
    VK_SUBPASS_DESCRIPTION_PER_VIEW_ATTRIBUTES_NVX = 0
    VK_SUBPASS_DESCRIPTION_PER_VIEW_POSITION_X_ONLY_NVX = 1
    VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_QCOM = 2
    VK_SUBPASS_DESCRIPTION_SHADER_RESOLVE_QCOM = 3
  VkPointClippingBehavior* {.size: 4.} = enum # XXX
    VK_POINT_CLIPPING_BEHAVIOR_ALL_CLIP_PLANES = 0
    VK_POINT_CLIPPING_BEHAVIOR_USER_CLIP_PLANES_ONLY = 1
  VkPointClippingBehaviorKHR* = enum
    VkPointClippingBehaviorKHRReserved
  VkCoverageModulationModeNV* {.size: 4.} = enum # XXX
    VK_COVERAGE_MODULATION_MODE_NONE_NV = 0
    VK_COVERAGE_MODULATION_MODE_RGB_NV = 1
    VK_COVERAGE_MODULATION_MODE_ALPHA_NV = 2
    VK_COVERAGE_MODULATION_MODE_RGBA_NV = 3
  VkCoverageReductionModeNV* {.size: 4.} = enum # XXX
    VK_COVERAGE_REDUCTION_MODE_MERGE_NV = 0
    VK_COVERAGE_REDUCTION_MODE_TRUNCATE_NV = 1
  VkValidationCacheHeaderVersionEXT* {.size: 4.} = enum # XXX
    VK_VALIDATION_CACHE_HEADER_VERSION_ONE_EXT = 1
  VkShaderInfoTypeAMD* {.size: 4.} = enum # XXX
    VK_SHADER_INFO_TYPE_STATISTICS_AMD = 0
    VK_SHADER_INFO_TYPE_BINARY_AMD = 1
    VK_SHADER_INFO_TYPE_DISASSEMBLY_AMD = 2
  VkQueueGlobalPriorityEXT* {.size: 4.} = enum # XXX
    VK_QUEUE_GLOBAL_PRIORITY_LOW_EXT = 128
    VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT = 256
    VK_QUEUE_GLOBAL_PRIORITY_HIGH_EXT = 512
    VK_QUEUE_GLOBAL_PRIORITY_REALTIME_EXT = 1024
  VkTimeDomainEXT* {.size: 4.} = enum # XXX
    VK_TIME_DOMAIN_DEVICE_EXT = 0
    VK_TIME_DOMAIN_CLOCK_MONOTONIC_EXT = 1
    VK_TIME_DOMAIN_CLOCK_MONOTONIC_RAW_EXT = 2
    VK_TIME_DOMAIN_QUERY_PERFORMANCE_COUNTER_EXT = 3
  VkConservativeRasterizationModeEXT* {.size: 4.} = enum # XXX
  ...
  VkResolveModeFlag* {.size: 4.} = enum
    VK_RESOLVE_MODE_SAMPLE_ZERO = 0
    VK_RESOLVE_MODE_AVERAGE = 1
    VK_RESOLVE_MODE_MIN = 2
    VK_RESOLVE_MODE_MAX = 3
  VkResolveModeFlagBitsKHR* = enum
    VkResolveModeFlagBitsKHRReserved
  ...
  VkDescriptorBindingFlag* {.size: 4.} = enum
    VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND = 0
    VK_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING = 1
    VK_DESCRIPTOR_BINDING_PARTIALLY_BOUND = 2
    VK_DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT = 3
  VkDescriptorBindingFlagBitsEXT* = enum
    VkDescriptorBindingFlagBitsEXTReserved
  VkConditionalRenderingFlagBitsEXT* {.size: 4.} = enum
    VK_CONDITIONAL_RENDERING_INVERTED_BIT_EXT = 1
  VkConditionalRenderingFlagEXT* {.size: 4.} = enum
    VK_CONDITIONAL_RENDERING_INVERTED_EXT = 0
  VkSemaphoreType* {.size: 4.} = enum # XXX
    VK_SEMAPHORE_TYPE_BINARY = 0
    VK_SEMAPHORE_TYPE_TIMELINE = 1
  VkSemaphoreTypeKHR* = enum
    VkSemaphoreTypeKHRReserved
  VkGeometryFlagBitsKHR* {.size: 4.} = enum
    VK_GEOMETRY_OPAQUE_BIT_KHR = 1
    VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_KHR = 2
  VkGeometryFlagKHR* {.size: 4.} = enum
    VK_GEOMETRY_OPAQUE_KHR = 0
    VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_KHR = 1
  VkGeometryFlagBitsNV* = enum
    VkGeometryFlagBitsNVReserved
  ...
  VkGeometryInstanceFlagKHR* {.size: 4.} = enum
    VK_GEOMETRY_INSTANCE_TRIANGLE_FACING_CULL_DISABLE_KHR = 0
    VK_GEOMETRY_INSTANCE_TRIANGLE_FRONT_COUNTERCLOCKWISE_KHR = 1
    VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_KHR = 2
    VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_KHR = 3
  VkGeometryInstanceFlagBitsNV* = enum
    VkGeometryInstanceFlagBitsNVReserved
  ...
  VkBuildAccelerationStructureFlagKHR* {.size: 4.} = enum
    VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_KHR = 0
    VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_KHR = 1
    VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_KHR = 2
    VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_KHR = 3
    VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_KHR = 4
  VkBuildAccelerationStructureFlagBitsNV* = enum
    VkBuildAccelerationStructureFlagBitsNVReserved
  VkCopyAccelerationStructureModeKHR* {.size: 4.} = enum # XXX
    VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_KHR = 0
    VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_KHR = 1
    VK_COPY_ACCELERATION_STRUCTURE_MODE_SERIALIZE_KHR = 2
    VK_COPY_ACCELERATION_STRUCTURE_MODE_DESERIALIZE_KHR = 3
  VkCopyAccelerationStructureModeNV* = enum
    VkCopyAccelerationStructureModeNVReserved
  VkAccelerationStructureTypeKHR* {.size: 4.} = enum # XXX
    VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR = 0
    VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR = 1
  VkAccelerationStructureTypeNV* = enum
    VkAccelerationStructureTypeNVReserved
  VkGeometryTypeKHR* {.size: 4.} = enum # XXX
    VK_GEOMETRY_TYPE_TRIANGLES_KHR = 0
    VK_GEOMETRY_TYPE_AABBS_KHR = 1
    VK_GEOMETRY_TYPE_INSTANCES_KHR = 1000150000
  VkGeometryTypeNV* = enum
    VkGeometryTypeNVReserved
  VkRayTracingShaderGroupTypeKHR* {.size: 4.} = enum # XXX
    VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR = 0
    VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR = 1
    VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR = 2
  VkRayTracingShaderGroupTypeNV* = enum
    VkRayTracingShaderGroupTypeNVReserved
  VkAccelerationStructureMemoryRequirementsTypeKHR* {.size: 4.} = enum # XXX
  ...
  VkAccelerationStructureMemoryRequirementsTypeNV* = enum
    VkAccelerationStructureMemoryRequirementsTypeNVReserved
  VkAccelerationStructureBuildTypeKHR* {.size: 4.} = enum # XXX
    VK_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_KHR = 0
    VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR = 1
    VK_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_OR_DEVICE_KHR = 2
  VkMemoryOverallocationBehaviorAMD* {.size: 4.} = enum # XXX
    VK_MEMORY_OVERALLOCATION_BEHAVIOR_DEFAULT_AMD = 0
    VK_MEMORY_OVERALLOCATION_BEHAVIOR_ALLOWED_AMD = 1
    VK_MEMORY_OVERALLOCATION_BEHAVIOR_DISALLOWED_AMD = 2
  VkScopeNV* {.size: 4.} = enum # XXX
    VK_SCOPE_DEVICE_NV = 1
    VK_SCOPE_WORKGROUP_NV = 2
    VK_SCOPE_SUBGROUP_NV = 3
    VK_SCOPE_QUEUE_FAMILY_NV = 5
  VkComponentTypeNV* {.size: 4.} = enum # XXX
  ...
  VkDeviceDiagnosticsConfigFlagNV* {.size: 4.} = enum
    VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_SHADER_DEBUG_INFO_NV = 0
    VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_RESOURCE_TRACKING_NV = 1
    VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_AUTOMATIC_CHECKPOINTS_NV = 2
  VkPipelineCreationFeedbackFlagBitsEXT* {.size: 4.} = enum
  ...
  VkPipelineCreationFeedbackFlagEXT* {.size: 4.} = enum
    VK_PIPELINE_CREATION_FEEDBACK_VALID_EXT = 0
    VK_PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_EXT = 1
    VK_PIPELINE_CREATION_FEEDBACK_BASE_PIPELINE_ACCELERATION_EXT = 2
  VkPerformanceCounterScopeKHR* {.size: 4.} = enum # XXX
    VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR = 0
    VK_PERFORMANCE_COUNTER_SCOPE_RENDER_PASS_KHR = 1
    VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_KHR = 2
  VkPerformanceCounterUnitKHR* {.size: 4.} = enum # XXX
  ...
  VkPerformanceCounterStorageKHR* {.size: 4.} = enum # XXX
  ...
  VkPerformanceCounterDescriptionFlagKHR* {.size: 4.} = enum
  ...
  VkAcquireProfilingLockFlagBitsKHR* = enum
    VkAcquireProfilingLockFlagBitsKHRReserved
  VkSemaphoreWaitFlagBits* {.size: 4.} = enum
    VK_SEMAPHORE_WAIT_ANY_BIT = 1
  VkSemaphoreWaitFlag* {.size: 4.} = enum
    VK_SEMAPHORE_WAIT_ANY = 0
  VkSemaphoreWaitFlagBitsKHR* = enum
    VkSemaphoreWaitFlagBitsKHRReserved
  VkPerformanceConfigurationTypeINTEL* {.size: 4.} = enum # XXX
    VK_PERFORMANCE_CONFIGURATION_TYPE_COMMAND_QUEUE_METRICS_DISCOVERY_ACTIVATED_INTEL = 0
  VkQueryPoolSamplingModeINTEL* {.size: 4.} = enum # XXX
    VK_QUERY_POOL_SAMPLING_MODE_MANUAL_INTEL = 0
  VkPerformanceOverrideTypeINTEL* {.size: 4.} = enum # XXX
    VK_PERFORMANCE_OVERRIDE_TYPE_NULL_HARDWARE_INTEL = 0
    VK_PERFORMANCE_OVERRIDE_TYPE_FLUSH_GPU_CACHES_INTEL = 1
  VkPerformanceParameterTypeINTEL* {.size: 4.} = enum # XXX
    VK_PERFORMANCE_PARAMETER_TYPE_HW_COUNTERS_SUPPORTED_INTEL = 0
    VK_PERFORMANCE_PARAMETER_TYPE_STREAM_MARKER_VALID_BITS_INTEL = 1
  VkPerformanceValueTypeINTEL* {.size: 4.} = enum # XXX
    VK_PERFORMANCE_VALUE_TYPE_UINT32_INTEL = 0
    VK_PERFORMANCE_VALUE_TYPE_UINT64_INTEL = 1
    VK_PERFORMANCE_VALUE_TYPE_FLOAT_INTEL = 2
    VK_PERFORMANCE_VALUE_TYPE_BOOL_INTEL = 3
    VK_PERFORMANCE_VALUE_TYPE_STRING_INTEL = 4
  VkLineRasterizationModeEXT* {.size: 4.} = enum # XXX
    VK_LINE_RASTERIZATION_MODE_DEFAULT_EXT = 0
    VK_LINE_RASTERIZATION_MODE_RECTANGULAR_EXT = 1
    VK_LINE_RASTERIZATION_MODE_BRESENHAM_EXT = 2
    VK_LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH_EXT = 3
  VkShaderModuleCreateFlagBits* = enum
    VkShaderModuleCreateFlagBitsReserved
  VkPipelineCompilerControlFlagBitsAMD* = enum
    VkPipelineCompilerControlFlagBitsAMDReserved
  VkShaderCorePropertiesFlagBitsAMD* = enum
    VkShaderCorePropertiesFlagBitsAMDReserved
  VkToolPurposeFlagBitsEXT* {.size: 4.} = enum
  ...
  VkToolPurposeFlagEXT* {.size: 4.} = enum
    VK_TOOL_PURPOSE_VALIDATION_EXT = 0
    VK_TOOL_PURPOSE_PROFILING_EXT = 1
    VK_TOOL_PURPOSE_TRACING_EXT = 2
    VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_EXT = 3
    VK_TOOL_PURPOSE_MODIFYING_FEATURES_EXT = 4
    VK_TOOL_PURPOSE_DEBUG_REPORTING_EXT = 5
    VK_TOOL_PURPOSE_DEBUG_MARKERS_EXT = 6
  VkColorSpaceKHR* {.size: 4.} = enum # XXX
  ...
  VkCompositeAlphaFlagKHR* {.size: 4.} = enum
    VK_COMPOSITE_ALPHA_OPAQUE_KHR = 0
    VK_COMPOSITE_ALPHA_PRE_MULTIPLIED_KHR = 1
    VK_COMPOSITE_ALPHA_POST_MULTIPLIED_KHR = 2
    VK_COMPOSITE_ALPHA_INHERIT_KHR = 3
  VkDisplayPlaneAlphaFlagBitsKHR* {.size: 4.} = enum
    VK_DISPLAY_PLANE_ALPHA_OPAQUE_BIT_KHR = 1
    VK_DISPLAY_PLANE_ALPHA_GLOBAL_BIT_KHR = 2
    VK_DISPLAY_PLANE_ALPHA_PER_PIXEL_BIT_KHR = 4
    VK_DISPLAY_PLANE_ALPHA_PER_PIXEL_PREMULTIPLIED_BIT_KHR = 8
  VkDisplayPlaneAlphaFlagKHR* {.size: 4.} = enum
    VK_DISPLAY_PLANE_ALPHA_OPAQUE_KHR = 0
    VK_DISPLAY_PLANE_ALPHA_GLOBAL_KHR = 1
    VK_DISPLAY_PLANE_ALPHA_PER_PIXEL_KHR = 2
    VK_DISPLAY_PLANE_ALPHA_PER_PIXEL_PREMULTIPLIED_KHR = 3
  VkPresentModeKHR* {.size: 4.} = enum # XXX
  ...
  VkSurfaceTransformFlagKHR* {.size: 4.} = enum
    VK_SURFACE_TRANSFORM_IDENTITY_KHR = 0
    VK_SURFACE_TRANSFORM_ROTATE_90_KHR = 1
    VK_SURFACE_TRANSFORM_ROTATE_180_KHR = 2
    VK_SURFACE_TRANSFORM_ROTATE_270_KHR = 3
    VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_KHR = 4
    VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_KHR = 5
    VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_KHR = 6
    VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_KHR = 7
  ...
  VkDebugReportFlagEXT* {.size: 4.} = enum
    VK_DEBUG_REPORT_INFORMATION_EXT = 0
    VK_DEBUG_REPORT_WARNING_EXT = 1
    VK_DEBUG_REPORT_PERFORMANCE_WARNING_EXT = 2
    VK_DEBUG_REPORT_ERROR_EXT = 3
    VK_DEBUG_REPORT_DEBUG_EXT = 4
  VkDebugReportObjectTypeEXT* {.size: 4.} = enum # XXX
  ...
  VkRasterizationOrderAMD* {.size: 4.} = enum # XXX
  ...
  VkExternalMemoryHandleTypeFlagNV* {.size: 4.} = enum
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_NV = 0
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_NV = 1
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE_NV = 2
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE_KMT_NV = 3
  VkExternalMemoryFeatureFlagBitsNV* {.size: 4.} = enum
    VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_NV = 1
    VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_NV = 2
    VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_NV = 4
  VkExternalMemoryFeatureFlagNV* {.size: 4.} = enum
    VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_NV = 0
    VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_NV = 1
    VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_NV = 2
  VkValidationCheckEXT* {.size: 4.} = enum # XXX
    VK_VALIDATION_CHECK_ALL_EXT = 0
    VK_VALIDATION_CHECK_SHADERS_EXT = 1
  VkValidationFeatureEnableEXT* {.size: 4.} = enum # XXX
    VK_VALIDATION_FEATURE_ENABLE_GPU_ASSISTED_EXT = 0
    VK_VALIDATION_FEATURE_ENABLE_GPU_ASSISTED_RESERVE_BINDING_SLOT_EXT = 1
    VK_VALIDATION_FEATURE_ENABLE_BEST_PRACTICES_EXT = 2
    VK_VALIDATION_FEATURE_ENABLE_DEBUG_PRINTF_EXT = 3
    VK_VALIDATION_FEATURE_ENABLE_SYNCHRONIZATION_VALIDATION_EXT = 4
  VkValidationFeatureDisableEXT* {.size: 4.} = enum # XXX
  ...
  VkExternalMemoryHandleTypeFlag* {.size: 4.} = enum
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD = 0
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32 = 1
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT = 2
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE = 3
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT = 4
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP = 5
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE = 6
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_ALLOCATION_EXT = 7
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_MAPPED_FOREIGN_MEMORY_EXT = 8
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_DMA_BUF_EXT = 9
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_ANDROID_HARDWARE_BUFFER_ANDROID = 10
  VkExternalMemoryHandleTypeFlagBitsKHR* = enum
    VkExternalMemoryHandleTypeFlagBitsKHRReserved
  VkExternalMemoryFeatureFlagBits* {.size: 4.} = enum
    VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT = 1
    VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT = 2
    VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT = 4
  VkExternalMemoryFeatureFlag* {.size: 4.} = enum
    VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY = 0
    VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE = 1
    VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE = 2
  VkExternalMemoryFeatureFlagBitsKHR* = enum
    VkExternalMemoryFeatureFlagBitsKHRReserved
  ...
  VkExternalSemaphoreHandleTypeFlag* {.size: 4.} = enum
    VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD = 0
    VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32 = 1
    VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT = 2
    VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE = 3
    VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_SYNC_FD = 4
  VkExternalSemaphoreHandleTypeFlagBitsKHR* = enum
    VkExternalSemaphoreHandleTypeFlagBitsKHRReserved
  VkExternalSemaphoreFeatureFlagBits* {.size: 4.} = enum
    VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT = 1
    VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT = 2
  VkExternalSemaphoreFeatureFlag* {.size: 4.} = enum
    VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE = 0
    VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE = 1
  VkExternalSemaphoreFeatureFlagBitsKHR* = enum
    VkExternalSemaphoreFeatureFlagBitsKHRReserved
  VkSemaphoreImportFlagBits* {.size: 4.} = enum
    VK_SEMAPHORE_IMPORT_TEMPORARY_BIT = 1
  VkSemaphoreImportFlag* {.size: 4.} = enum
    VK_SEMAPHORE_IMPORT_TEMPORARY = 0
  VkSemaphoreImportFlagBitsKHR* = enum
    VkSemaphoreImportFlagBitsKHRReserved
  VkExternalFenceHandleTypeFlagBits* {.size: 4.} = enum
    VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_FD_BIT = 1
    VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_BIT = 2
    VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT = 4
    VK_EXTERNAL_FENCE_HANDLE_TYPE_SYNC_FD_BIT = 8
  VkExternalFenceHandleTypeFlag* {.size: 4.} = enum
    VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_FD = 0
    VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32 = 1
    VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_KMT = 2
    VK_EXTERNAL_FENCE_HANDLE_TYPE_SYNC_FD = 3
  VkExternalFenceHandleTypeFlagBitsKHR* = enum
    VkExternalFenceHandleTypeFlagBitsKHRReserved
  VkExternalFenceFeatureFlagBits* {.size: 4.} = enum
    VK_EXTERNAL_FENCE_FEATURE_EXPORTABLE_BIT = 1
    VK_EXTERNAL_FENCE_FEATURE_IMPORTABLE_BIT = 2
  VkExternalFenceFeatureFlag* {.size: 4.} = enum
    VK_EXTERNAL_FENCE_FEATURE_EXPORTABLE = 0
    VK_EXTERNAL_FENCE_FEATURE_IMPORTABLE = 1
  VkExternalFenceFeatureFlagBitsKHR* = enum
    VkExternalFenceFeatureFlagBitsKHRReserved
  VkFenceImportFlagBits* {.size: 4.} = enum
    VK_FENCE_IMPORT_TEMPORARY_BIT = 1
  VkFenceImportFlag* {.size: 4.} = enum
    VK_FENCE_IMPORT_TEMPORARY = 0
  VkFenceImportFlagBitsKHR* = enum
    VkFenceImportFlagBitsKHRReserved
  VkSurfaceCounterFlagBitsEXT* {.size: 4.} = enum
    VK_SURFACE_COUNTER_VBLANK_BIT_EXT = 1
  VkSurfaceCounterFlagEXT* {.size: 4.} = enum
    VK_SURFACE_COUNTER_VBLANK_EXT = 0
  VkDisplayPowerStateEXT* {.size: 4.} = enum # XXX
    VK_DISPLAY_POWER_STATE_OFF_EXT = 0
    VK_DISPLAY_POWER_STATE_SUSPEND_EXT = 1
    VK_DISPLAY_POWER_STATE_ON_EXT = 2
  VkDeviceEventTypeEXT* {.size: 4.} = enum # XXX
    VK_DEVICE_EVENT_TYPE_DISPLAY_HOTPLUG_EXT = 0
  VkDisplayEventTypeEXT* {.size: 4.} = enum # XXX
  ...
  VkPeerMemoryFeatureFlag* {.size: 4.} = enum
    VK_PEER_MEMORY_FEATURE_COPY_SRC = 0
    VK_PEER_MEMORY_FEATURE_COPY_DST = 1
    VK_PEER_MEMORY_FEATURE_GENERIC_SRC = 2
    VK_PEER_MEMORY_FEATURE_GENERIC_DST = 3
  VkPeerMemoryFeatureFlagBitsKHR* = enum
    VkPeerMemoryFeatureFlagBitsKHRReserved
  ...
  VkMemoryAllocateFlag* {.size: 4.} = enum
    VK_MEMORY_ALLOCATE_DEVICE_MASK = 0
    VK_MEMORY_ALLOCATE_DEVICE_ADDRESS = 1
    VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY = 2
  VkMemoryAllocateFlagBitsKHR* = enum
    VkMemoryAllocateFlagBitsKHRReserved
  VkDeviceGroupPresentModeFlagBitsKHR* {.size: 4.} = enum
    VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_BIT_KHR = 1
    VK_DEVICE_GROUP_PRESENT_MODE_REMOTE_BIT_KHR = 2
    VK_DEVICE_GROUP_PRESENT_MODE_SUM_BIT_KHR = 4
    VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_MULTI_DEVICE_BIT_KHR = 8
  VkDeviceGroupPresentModeFlagKHR* {.size: 4.} = enum
    VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_KHR = 0
    VK_DEVICE_GROUP_PRESENT_MODE_REMOTE_KHR = 1
    VK_DEVICE_GROUP_PRESENT_MODE_SUM_KHR = 2
    VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_MULTI_DEVICE_KHR = 3
  VkSwapchainCreateFlagBitsKHR* {.size: 4.} = enum
    VK_SWAPCHAIN_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR = 1
    VK_SWAPCHAIN_CREATE_PROTECTED_BIT_KHR = 2
    VK_SWAPCHAIN_CREATE_MUTABLE_FORMAT_BIT_KHR = 4
  VkSwapchainCreateFlagKHR* {.size: 4.} = enum
    VK_SWAPCHAIN_CREATE_SPLIT_INSTANCE_BIND_REGIONS_KHR = 0
    VK_SWAPCHAIN_CREATE_PROTECTED_KHR = 1
    VK_SWAPCHAIN_CREATE_MUTABLE_FORMAT_KHR = 2
  ...
  VkSubgroupFeatureFlag* {.size: 4.} = enum
    VK_SUBGROUP_FEATURE_BASIC = 0
    VK_SUBGROUP_FEATURE_VOTE = 1
    VK_SUBGROUP_FEATURE_ARITHMETIC = 2
    VK_SUBGROUP_FEATURE_BALLOT = 3
    VK_SUBGROUP_FEATURE_SHUFFLE = 4
    VK_SUBGROUP_FEATURE_SHUFFLE_RELATIVE = 5
    VK_SUBGROUP_FEATURE_CLUSTERED = 6
    VK_SUBGROUP_FEATURE_QUAD = 7
    VK_SUBGROUP_FEATURE_PARTITIONED_NV = 8
  VkTessellationDomainOrigin* {.size: 4.} = enum # XXX
    VK_TESSELLATION_DOMAIN_ORIGIN_UPPER_LEFT = 0
    VK_TESSELLATION_DOMAIN_ORIGIN_LOWER_LEFT = 1
  VkTessellationDomainOriginKHR* = enum
    VkTessellationDomainOriginKHRReserved
  VkSamplerYcbcrModelConversion* {.size: 4.} = enum # XXX
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_RGB_IDENTITY = 0
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_IDENTITY = 1
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_709 = 2
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_601 = 3
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_2020 = 4
  VkSamplerYcbcrModelConversionKHR* = enum
    VkSamplerYcbcrModelConversionKHRReserved
  VkSamplerYcbcrRange* {.size: 4.} = enum # XXX
    VK_SAMPLER_YCBCR_RANGE_ITU_FULL = 0
    VK_SAMPLER_YCBCR_RANGE_ITU_NARROW = 1
  VkSamplerYcbcrRangeKHR* = enum
    VkSamplerYcbcrRangeKHRReserved
  VkChromaLocation* {.size: 4.} = enum # XXX
    VK_CHROMA_LOCATION_COSITED_EVEN = 0
    VK_CHROMA_LOCATION_MIDPOINT = 1
  VkChromaLocationKHR* = enum
    VkChromaLocationKHRReserved
  VkSamplerReductionMode* {.size: 4.} = enum # XXX
    VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE = 0
    VK_SAMPLER_REDUCTION_MODE_MIN = 1
    VK_SAMPLER_REDUCTION_MODE_MAX = 2
  VkSamplerReductionModeEXT* = enum
    VkSamplerReductionModeEXTReserved
  VkBlendOverlapEXT* {.size: 4.} = enum # XXX
  ...
  VkDebugUtilsMessageSeverityFlagEXT* {.size: 4.} = enum
    VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_EXT = 0
    VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_EXT = 4
    VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_EXT = 8
    VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_EXT = 12
  VkDebugUtilsMessageTypeFlagBitsEXT* {.size: 4.} = enum
    VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT = 1
    VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT = 2
    VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT = 4
  VkDebugUtilsMessageTypeFlagEXT* {.size: 4.} = enum
    VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_EXT = 0
    VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_EXT = 1
    VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_EXT = 2
  VkFullScreenExclusiveEXT* {.size: 4.} = enum # XXX
    VK_FULL_SCREEN_EXCLUSIVE_DEFAULT_EXT = 0
    VK_FULL_SCREEN_EXCLUSIVE_ALLOWED_EXT = 1
    VK_FULL_SCREEN_EXCLUSIVE_DISALLOWED_EXT = 2
    VK_FULL_SCREEN_EXCLUSIVE_APPLICATION_CONTROLLED_EXT = 3
  VkShaderFloatControlsIndependence* {.size: 4.} = enum # XXX
    VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY = 0
    VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL = 1
    VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE = 2
  VkShaderFloatControlsIndependenceKHR* = enum
    VkShaderFloatControlsIndependenceKHRReserved
  VkVendorId* {.size: 4.} = enum # XXX
    VK_VENDOR_ID_VIV = 0x10001
    VK_VENDOR_ID_VSI = 0x10002
    VK_VENDOR_ID_KAZAN = 0x10003
    VK_VENDOR_ID_CODEPLAY = 0x10004
    VK_VENDOR_ID_MESA = 0x10005
  VkDriverId* {.size: 4.} = enum # XXX
  ...
  VkDriverIdKHR* = enum
    VkDriverIdKHRReserved
  VkShadingRatePaletteEntryNV* {.size: 4.} = enum # XXX
  ...
  VkCoarseSampleOrderTypeNV* {.size: 4.} = enum # XXX
    VK_COARSE_SAMPLE_ORDER_TYPE_DEFAULT_NV = 0
    VK_COARSE_SAMPLE_ORDER_TYPE_CUSTOM_NV = 1
    VK_COARSE_SAMPLE_ORDER_TYPE_PIXEL_MAJOR_NV = 2
    VK_COARSE_SAMPLE_ORDER_TYPE_SAMPLE_MAJOR_NV = 3
  VkPipelineExecutableStatisticFormatKHR* {.size: 4.} = enum # XXX
  ...
  VkFramebufferCreateFlags* {.size:4} = set[VkFramebufferCreateFlag]
  VkQueryPoolCreateFlags* {.size:4} = set[VkReserved]
  VkRenderPassCreateFlags* {.size:4} = set[VkRenderPassCreateFlag]
  VkSamplerCreateFlags* {.size:4} = set[VkSamplerCreateFlag]
  VkPipelineLayoutCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineCacheCreateFlags* {.size:4} = set[VkPipelineCacheCreateFlag]
  VkPipelineDepthStencilStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineDynamicStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineColorBlendStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineMultisampleStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineRasterizationStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineViewportStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineTessellationStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineInputAssemblyStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineVertexInputStateCreateFlags* {.size:4} = set[VkReserved]
  VkPipelineShaderStageCreateFlags* {.size:4} = set[VkPipelineShaderStageCreateFlag]
  VkDescriptorSetLayoutCreateFlags* {.size:4} = set[VkDescriptorSetLayoutCreateFlag]
  VkBufferViewCreateFlags* {.size:4} = set[VkReserved]
  VkInstanceCreateFlags* {.size:4} = set[VkReserved]
  VkDeviceCreateFlags* {.size:4} = set[VkReserved]
  VkDeviceQueueCreateFlags* {.size:4} = set[VkDeviceQueueCreateFlag]
  VkQueueFlags* {.size:4} = set[VkQueueFlag]
  VkMemoryPropertyFlags* {.size:4} = set[VkMemoryPropertyFlag]
  VkMemoryHeapFlags* {.size:4} = set[VkMemoryHeapFlag]
  VkAccessFlags* {.size:4} = set[VkAccessFlag]
  VkBufferUsageFlags* {.size:4} = set[VkBufferUsageFlag]
  VkBufferCreateFlags* {.size:4} = set[VkBufferCreateFlag]
  VkShaderStageFlags* {.size:4} = set[VkShaderStageFlag]
  VkImageUsageFlags* {.size:4} = set[VkImageUsageFlag]
  VkImageCreateFlags* {.size:4} = set[VkImageCreateFlag]
  VkImageViewCreateFlags* {.size:4} = set[VkImageViewCreateFlag]
  VkPipelineCreateFlags* {.size:4} = set[VkPipelineCreateFlag]
  VkColorComponentFlags* {.size:4} = set[VkColorComponentFlag]
  VkFenceCreateFlags* {.size:4} = set[VkFenceCreateFlag]
  VkSemaphoreCreateFlags* {.size:4} = set[VkReserved]
  VkFormatFeatureFlags* {.size:4} = set[VkFormatFeatureFlag]
  VkQueryControlFlags* {.size:4} = set[VkQueryControlFlag]
  VkQueryResultFlags* {.size:4} = set[VkQueryResultFlag]
  VkShaderModuleCreateFlags* {.size:4} = set[VkReserved]
  VkEventCreateFlags* {.size:4} = set[VkReserved]
  VkCommandPoolCreateFlags* {.size:4} = set[VkCommandPoolCreateFlag]
  VkCommandPoolResetFlags* {.size:4} = set[VkCommandPoolResetFlag]
  VkCommandBufferResetFlags* {.size:4} = set[VkCommandBufferResetFlag]
  VkCommandBufferUsageFlags* {.size:4} = set[VkCommandBufferUsageFlag]
  VkQueryPipelineStatisticFlags* {.size:4} = set[VkQueryPipelineStatisticFlag]
  VkMemoryMapFlags* {.size:4} = set[VkReserved]
  VkImageAspectFlags* {.size:4} = set[VkImageAspectFlag]
  VkSparseMemoryBindFlags* {.size:4} = set[VkSparseMemoryBindFlag]
  VkSparseImageFormatFlags* {.size:4} = set[VkSparseImageFormatFlag]
  VkSubpassDescriptionFlags* {.size:4} = set[VkSubpassDescriptionFlag]
  VkPipelineStageFlags* {.size:4} = set[VkPipelineStageFlag]
  VkSampleCountFlags* {.size:4} = set[VkSampleCountFlag]
  VkAttachmentDescriptionFlags* {.size:4} = set[VkAttachmentDescriptionFlag]
  VkStencilFaceFlags* {.size:4} = set[VkStencilFaceFlag]
  VkCullModeFlags* {.size:4} = set[VkCullModeFlag]
  VkDescriptorPoolCreateFlags* {.size:4} = set[VkDescriptorPoolCreateFlag]
  VkDescriptorPoolResetFlags* {.size:4} = set[VkReserved]
  VkDependencyFlags* {.size:4} = set[VkDependencyFlag]
  VkSubgroupFeatureFlags* {.size:4} = set[VkSubgroupFeatureFlag]
  VkIndirectCommandsLayoutUsageFlagsNV* {.size:4} = set[VkIndirectCommandsLayoutUsageFlagNV]
  VkIndirectStateFlagsNV* {.size:4} = set[VkIndirectStateFlagNV]
  VkGeometryFlagsKHR* {.size:4} = set[VkGeometryFlagKHR]
  VkGeometryFlagsNV* = VkGeometryFlagsKHR
  VkGeometryInstanceFlagsKHR* {.size:4} = set[VkGeometryInstanceFlagKHR]
  VkGeometryInstanceFlagsNV* = VkGeometryInstanceFlagsKHR
  VkBuildAccelerationStructureFlagsKHR* {.size:4} = set[VkBuildAccelerationStructureFlagKHR]
  VkBuildAccelerationStructureFlagsNV* = VkBuildAccelerationStructureFlagsKHR
  VkPrivateDataSlotCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkDescriptorUpdateTemplateCreateFlags* {.size:4} = set[VkReserved]
  VkDescriptorUpdateTemplateCreateFlagsKHR* = VkDescriptorUpdateTemplateCreateFlags
  VkPipelineCreationFeedbackFlagsEXT* {.size:4} = set[VkPipelineCreationFeedbackFlagEXT]
  VkPerformanceCounterDescriptionFlagsKHR* {.size:4} = set[VkPerformanceCounterDescriptionFlagKHR]
  VkAcquireProfilingLockFlagsKHR* {.size:4} = set[VkReserved]
  VkSemaphoreWaitFlags* {.size:4} = set[VkSemaphoreWaitFlag]
  VkSemaphoreWaitFlagsKHR* = VkSemaphoreWaitFlags
  VkPipelineCompilerControlFlagsAMD* {.size:4} = set[VkReserved]
  VkShaderCorePropertiesFlagsAMD* {.size:4} = set[VkReserved]
  VkDeviceDiagnosticsConfigFlagsNV* {.size:4} = set[VkDeviceDiagnosticsConfigFlagNV]
  VkCompositeAlphaFlagsKHR* {.size:4} = set[VkCompositeAlphaFlagKHR]
  VkDisplayPlaneAlphaFlagsKHR* {.size:4} = set[VkDisplayPlaneAlphaFlagKHR]
  VkSurfaceTransformFlagsKHR* {.size:4} = set[VkSurfaceTransformFlagKHR]
  VkSwapchainCreateFlagsKHR* {.size:4} = set[VkSwapchainCreateFlagKHR]
  VkDisplayModeCreateFlagsKHR* {.size:4} = set[VkReserved]
  VkDisplaySurfaceCreateFlagsKHR* {.size:4} = set[VkReserved]
  VkAndroidSurfaceCreateFlagsKHR* {.size:4} = set[VkReserved]
  VkViSurfaceCreateFlagsNN* {.size:4} = set[VkReserved]
  VkWaylandSurfaceCreateFlagsKHR* {.size:4} = set[VkReserved]
  VkWin32SurfaceCreateFlagsKHR* {.size:4} = set[VkReserved]
  VkXlibSurfaceCreateFlagsKHR* {.size:4} = set[VkReserved]
  VkXcbSurfaceCreateFlagsKHR* {.size:4} = set[VkReserved]
  VkDirectFBSurfaceCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkIOSSurfaceCreateFlagsMVK* {.size:4} = set[VkReserved]
  VkMacOSSurfaceCreateFlagsMVK* {.size:4} = set[VkReserved]
  VkMetalSurfaceCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkImagePipeSurfaceCreateFlagsFUCHSIA* {.size:4} = set[VkReserved]
  VkStreamDescriptorSurfaceCreateFlagsGGP* {.size:4} = set[VkReserved]
  VkHeadlessSurfaceCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkPeerMemoryFeatureFlags* {.size:4} = set[VkPeerMemoryFeatureFlag]
  VkPeerMemoryFeatureFlagsKHR* = VkPeerMemoryFeatureFlags
  VkMemoryAllocateFlags* {.size:4} = set[VkMemoryAllocateFlag]
  VkMemoryAllocateFlagsKHR* = VkMemoryAllocateFlags
  VkDeviceGroupPresentModeFlagsKHR* {.size:4} = set[VkDeviceGroupPresentModeFlagKHR]
  VkDebugReportFlagsEXT* {.size:4} = set[VkDebugReportFlagEXT]
  VkCommandPoolTrimFlags* {.size:4} = set[VkReserved]
  VkCommandPoolTrimFlagsKHR* = VkCommandPoolTrimFlags
  VkExternalMemoryHandleTypeFlagsNV* {.size:4} = set[VkExternalMemoryHandleTypeFlagNV]
  VkExternalMemoryFeatureFlagsNV* {.size:4} = set[VkExternalMemoryFeatureFlagNV]
  VkExternalMemoryHandleTypeFlags* {.size:4} = set[VkExternalMemoryHandleTypeFlag]
  VkExternalMemoryHandleTypeFlagsKHR* = VkExternalMemoryHandleTypeFlags
  VkExternalMemoryFeatureFlags* {.size:4} = set[VkExternalMemoryFeatureFlag]
  VkExternalMemoryFeatureFlagsKHR* = VkExternalMemoryFeatureFlags
  VkExternalSemaphoreHandleTypeFlags* {.size:4} = set[VkExternalSemaphoreHandleTypeFlag]
  VkExternalSemaphoreHandleTypeFlagsKHR* = VkExternalSemaphoreHandleTypeFlags
  VkExternalSemaphoreFeatureFlags* {.size:4} = set[VkExternalSemaphoreFeatureFlag]
  VkExternalSemaphoreFeatureFlagsKHR* = VkExternalSemaphoreFeatureFlags
  VkSemaphoreImportFlags* {.size:4} = set[VkSemaphoreImportFlag]
  VkSemaphoreImportFlagsKHR* = VkSemaphoreImportFlags
  VkExternalFenceHandleTypeFlags* {.size:4} = set[VkExternalFenceHandleTypeFlag]
  VkExternalFenceHandleTypeFlagsKHR* = VkExternalFenceHandleTypeFlags
  VkExternalFenceFeatureFlags* {.size:4} = set[VkExternalFenceFeatureFlag]
  VkExternalFenceFeatureFlagsKHR* = VkExternalFenceFeatureFlags
  VkFenceImportFlags* {.size:4} = set[VkFenceImportFlag]
  VkFenceImportFlagsKHR* = VkFenceImportFlags
  VkSurfaceCounterFlagsEXT* {.size:4} = set[VkSurfaceCounterFlagEXT]
  VkPipelineViewportSwizzleStateCreateFlagsNV* {.size:4} = set[VkReserved]
  VkPipelineDiscardRectangleStateCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkPipelineCoverageToColorStateCreateFlagsNV* {.size:4} = set[VkReserved]
  VkPipelineCoverageModulationStateCreateFlagsNV* {.size:4} = set[VkReserved]
  VkPipelineCoverageReductionStateCreateFlagsNV* {.size:4} = set[VkReserved]
  VkValidationCacheCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkDebugUtilsMessageSeverityFlagsEXT* {.size:4} = set[VkDebugUtilsMessageSeverityFlagEXT]
  VkDebugUtilsMessageTypeFlagsEXT* {.size:4} = set[VkDebugUtilsMessageTypeFlagEXT]
  VkDebugUtilsMessengerCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkDebugUtilsMessengerCallbackDataFlagsEXT* {.size:4} = set[VkReserved]
  VkPipelineRasterizationConservativeStateCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkDescriptorBindingFlags* {.size:4} = set[VkDescriptorBindingFlag]
  VkDescriptorBindingFlagsEXT* = VkDescriptorBindingFlags
  VkConditionalRenderingFlagsEXT* {.size:4} = set[VkConditionalRenderingFlagEXT]
  VkResolveModeFlags* {.size:4} = set[VkResolveModeFlag]
  VkResolveModeFlagsKHR* = VkResolveModeFlags
  VkPipelineRasterizationStateStreamCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkPipelineRasterizationDepthClipStateCreateFlagsEXT* {.size:4} = set[VkReserved]
  VkToolPurposeFlagsEXT* {.size:4} = set[VkToolPurposeFlagEXT]
...
proc mkVkPhysicalDevicePortabilitySubsetPropertiesKHR*(
...
proc mkVkPhysicalDevicePortabilitySubsetFeaturesKHR*(
...
proc mkVkCopyBufferToImageInfo2KHR*(
...
proc mkVkCopyImageToBufferInfo2KHR*(
...
proc loadProcs*(inst: VkInstance) =
  ...
  vkCmdBlitImage2KHR = cast[proc (commandBuffer: VkCommandBuffer, pBlitImageInfo: ptr VkBlitImageInfo2KHR): void {.stdcall.}](loadProc(inst, "vkCmdBlitImage2KHR"))
  ...
  vkCmdCopyBuffer2KHR = cast[proc (commandBuffer: VkCommandBuffer, pCopyBufferInfo: ptr VkCopyBufferInfo2KHR): void {.stdcall.}](loadProc(inst, "vkCmdCopyBuffer2KHR"))
  ...
  vkCmdCopyBufferToImage2KHR = cast[proc (commandBuffer: VkCommandBuffer, pCopyBufferToImageInfo: ptr VkCopyBufferToImageInfo2KHR): void {.stdcall.}](loadProc(inst, "vkCmdCopyBufferToImage2KHR"))
  ...
  vkCmdCopyImage2KHR = cast[proc (commandBuffer: VkCommandBuffer, pCopyImageInfo: ptr VkCopyImageInfo2KHR): void {.stdcall.}](loadProc(inst, "vkCmdCopyImage2KHR"))
  ...
  vkCmdCopyImageToBuffer2KHR = cast[proc (commandBuffer: VkCommandBuffer, pCopyImageToBufferInfo: ptr VkCopyImageToBufferInfo2KHR): void {.stdcall.}](loadProc(inst, "vkCmdCopyImageToBuffer2KHR"))
  ...
  vkCmdResolveImage2KHR = cast[proc (commandBuffer: VkCommandBuffer, pResolveImageInfo: ptr VkResolveImageInfo2KHR): void {.stdcall.}](loadProc(inst, "vkCmdResolveImage2KHR"))
...
const
  ...
  VK_KHR_COPY_COMMANDS_2_EXTENSION_NAME* = "VK_KHR_copy_commands2".cstring
  VK_KHR_COPY_COMMANDS_2_SPEC_VERSION* = 1.cuint
  ...
  VK_KHR_PORTABILITY_SUBSET_EXTENSION_NAME* = "VK_KHR_portability_subset".cstring
  VK_KHR_PORTABILITY_SUBSET_SPEC_VERSION* = 1.cuint
...
var
  ...
  vkCmdBlitImage2KHR*: proc (commandBuffer: VkCommandBuffer, pBlitImageInfo: ptr VkBlitImageInfo2KHR): void {.stdcall.}
  ...
  vkCmdCopyBuffer2KHR*: proc (commandBuffer: VkCommandBuffer, pCopyBufferInfo: ptr VkCopyBufferInfo2KHR): void {.stdcall.}
  ...
  vkCmdCopyBufferToImage2KHR*: proc (commandBuffer: VkCommandBuffer, pCopyBufferToImageInfo: ptr VkCopyBufferToImageInfo2KHR): void {.stdcall.}
  ...
  vkCmdCopyImage2KHR*: proc (commandBuffer: VkCommandBuffer, pCopyImageInfo: ptr VkCopyImageInfo2KHR): void {.stdcall.}
  ...
  vkCmdCopyImageToBuffer2KHR*: proc (commandBuffer: VkCommandBuffer, pCopyImageToBufferInfo: ptr VkCopyImageToBufferInfo2KHR): void {.stdcall.}
  ...
  vkCmdResolveImage2KHR*: proc (commandBuffer: VkCommandBuffer, pResolveImageInfo: ptr VkResolveImageInfo2KHR): void {.stdcall.}
